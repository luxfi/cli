...
import (
	...
	"github.com/luxfi/cli/v2/cmd/configcmd"

	"github.com/luxfi/cli/v2/cmd/backendcmd"
	"github.com/luxfi/cli/v2/cmd/blockchaincmd"
	"github.com/luxfi/cli/v2/cmd/contractcmd"
	"github.com/luxfi/cli/v2/cmd/databasecmd"
	"github.com/luxfi/cli/v2/cmd/genesiscmd"
	"github.com/luxfi/cli/v2/cmd/interchaincmd"
	"github.com/luxfi/cli/v2/cmd/keycmd"
	"github.com/luxfi/cli/v2/cmd/l1cmd"
	"github.com/luxfi/cli/v2/cmd/l3cmd"
	"github.com/luxfi/cli/v2/cmd/localcmd"
	"github.com/luxfi/cli/v2/cmd/migratecmd"
	"github.com/luxfi/cli/v2/cmd/networkcmd"
	"github.com/luxfi/cli/v2/cmd/nodecmd"
	"github.com/luxfi/cli/v2/cmd/primarycmd"
	"github.com/luxfi/cli/v2/cmd/subnetcmd"
	"github.com/luxfi/cli/v2/cmd/transactioncmd"
	"github.com/luxfi/cli/v2/cmd/updatecmd"
	"github.com/luxfi/cli/v2/cmd/validatorcmd"
	"github.com/luxfi/cli/v2/internal/migrations"
