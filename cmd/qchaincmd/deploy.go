...
This command initializes the Q-Chain with Corona signatures and quantum-safe consensus.`,
		RunE: deployQChain,
	}
...
func deployQChain(cmd *cobra.Command, args []string) error {
	...
	ux.Logger.PrintToUser("  Signature Algorithm: Corona-256")
	...
	if quantumSafe {
		...
		ux.Logger.PrintToUser("  ✓ Corona signature scheme enabled")
