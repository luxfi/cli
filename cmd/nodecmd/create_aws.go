...
import (
	...
	terraformaws "github.com/luxdefi/cli/pkg/terraform/aws"
...
func createEC2Instances(rootBody *hclwrite.Body,
	...
	for _, region := range regions {
		...
		if !securityGroupExists {
			...
			ipInHTTP := awsAPI.CheckUserIPInSg(sg, userIPAddress, constants.LuxgoAPIPort)
...
func createAWSInstances(
	...
	for _, region := range regions {
		prefix := usr.Username + "-" + region + constants.LuxCLISuffix
