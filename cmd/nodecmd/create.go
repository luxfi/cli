...
import (
	...
	awsAPI "github.com/luxdefi/cli/pkg/aws"
	gcpAPI "github.com/luxdefi/cli/pkg/gcp"
...
func createNodes(_ *cobra.Command, args []string) error {
	...
	ux.Logger.PrintToUser("LUX NODE(S) STATUS")
	ux.Logger.PrintToUser("======================================")
	ux.Logger.PrintToUser("")
...
// createClusterNodeConfig creates node config and save it in .cli/nodes/{instanceID}
// also creates cluster config in .cli/nodes storing various key pair and security group info for all clusters
