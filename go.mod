...
require (
	...
	github.com/luxfi/node v1.23.31 // indirect
...
// Local replacements for domain CLI packages (until next tag release)
...
require (
	...
	github.com/luxfi/ringtail v0.3.0
