...
require (
	...
	github.com/luxfi/sdk v0.0.0-00010101000000-000000000000
...
// No replace directives - all dependencies use proper tagged versions
...
require (
	...
	github.com/luxfi/consensus v1.1.0 // indirect
...
replace (
	github.com/luxdefi/ledger/go => github.com/luxfi/ledger/go v0.7.1
