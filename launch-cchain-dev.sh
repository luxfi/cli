...
# Launch script for C-Chain in dev mode with skip-bootstrap
# This enables single-node development mode with the migrated database

echo "Starting LUX node in dev mode with skip-bootstrap for C-Chain..."
...
# Start luxd in dev mode with skip-bootstrap
