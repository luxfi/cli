...
go build -v -ldflags="-X 'github.com/luxdefi/cli/cmd.Version=$VERSION' -X github.com/luxdefi/cli/pkg/utils.telemetryToken=$TELEMETRY_TOKEN" $extra_build_args -o bin/lux
