...
import (
	...
	client "github.com/luxfi/netrunner/client"

	mock "github.com/stretchr/testify/mock"

	rpcpb "github.com/luxfi/netrunner/rpcpb"
...
func (_m *Client) CreateChains(ctx context.Context, chainSpecs []*rpcpb.BlockchainSpec) (*rpcpb.CreateBlockchainsResponse, error) {
	ret := _m.Called(ctx, chainSpecs)

	if len(ret) == 0 {
		panic("no return value specified for CreateChains")
	}
...
func (_m *Client) CreateParticipantGroups(ctx context.Context, participantsSpecs []*rpcpb.ChainSpec) (*rpcpb.CreateChainsResponse, error) {
	ret := _m.Called(ctx, participantsSpecs)

	if len(ret) == 0 {
		panic("no return value specified for CreateParticipantGroups")
	}

	var r0 *rpcpb.CreateChainsResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []*rpcpb.ChainSpec) (*rpcpb.CreateChainsResponse, error)); ok {
		return rf(ctx, participantsSpecs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []*rpcpb.ChainSpec) *rpcpb.CreateChainsResponse); ok {
		r0 = rf(ctx, participantsSpecs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*rpcpb.CreateChainsResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, []*rpcpb.ChainSpec) error); ok {
		r1 = rf(ctx, participantsSpecs)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Client) RemoveChainValidator(ctx context.Context, validatorSpec []*rpcpb.RemoveChainValidatorSpec) (*rpcpb.RemoveChainValidatorResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for RemoveChainValidator")
	}

	var r0 *rpcpb.RemoveChainValidatorResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []*rpcpb.RemoveChainValidatorSpec) (*rpcpb.RemoveChainValidatorResponse, error)); ok {
		return rf(ctx, validatorSpec)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []*rpcpb.RemoveChainValidatorSpec) *rpcpb.RemoveChainValidatorResponse); ok {
		r0 = rf(ctx, validatorSpec)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*rpcpb.RemoveChainValidatorResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, []*rpcpb.RemoveChainValidatorSpec) error); ok {
		r1 = rf(ctx, validatorSpec)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Client) TransformElasticChains(ctx context.Context, elasticChainSpecs []*rpcpb.ElasticChainSpec) (*rpcpb.TransformElasticChainsResponse, error) {
	ret := _m.Called(ctx, elasticChainSpecs)

	if len(ret) == 0 {
		panic("no return value specified for TransformElasticChains")
	}

	var r0 *rpcpb.TransformElasticChainsResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []*rpcpb.ElasticChainSpec) (*rpcpb.TransformElasticChainsResponse, error)); ok {
		return rf(ctx, elasticChainSpecs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []*rpcpb.ElasticChainSpec) *rpcpb.TransformElasticChainsResponse); ok {
		r0 = rf(ctx, elasticChainSpecs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*rpcpb.TransformElasticChainsResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, []*rpcpb.ElasticChainSpec) error); ok {
		r1 = rf(ctx, elasticChainSpecs)
	} else {
		r1 = ret.Error(1)
	}
