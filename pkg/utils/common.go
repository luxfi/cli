...
// Example: https://github.com/luxfi/hypersdk/pull/772/commits/b88acfb370f5aeb83a000aece2d72f28154410a5
// Should return https://github.com/luxfi/hypersdk
func GetRepoFromCommitURL(gitRepoURL string) (string, string) {
	splitURL := strings.Split(gitRepoURL, "/")
	if len(splitURL) > 4 {
		// get first five members of splitURL because it will be [ https, ' ', github.com, luxfi, hypersdk]
