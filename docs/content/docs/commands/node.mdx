...
# Add bootstrap nodes
lux node configure \
  --bootstrap-ips=1.2.3.4:9631,5.6.7.8:9631
```
...
export LUX_HTTP_PORT=9630
export LUX_STAKING_PORT=9631
...
ufw allow 9631/tcp comment 'Lux staking'
ufw allow from 127.0.0.1 to any port 9630 comment 'Lux API local only'
ufw enable
```
