...
module.exports = {
  networks: {
    ...
    luxTestnet: {
      url: "https://api.testnet.lux.network/v1/chain/C/rpc",
      chainId: 99998,
      accounts: [process.env.PRIVATE_KEY]
    }
  }
...
[rpc_endpoints]
lux_local = "http://127.0.0.1:9630/v1/chain/C/rpc"
lux_testnet = "https://api.testnet.lux.network/v1/chain/C/rpc"
```
...
lux blockchain create defi-chain --vm=evm
